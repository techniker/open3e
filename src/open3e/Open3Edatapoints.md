...
- Version of general data points: 20260207
- Version of variant data points: 20260207

## Frequently used data points
|  Did | ID   | Codec | Length | Unit | Description | Further info |
| ---: | :--- | :--- | ---: | :---: | :--- | :--- |
...
**268**|**FlowTemperatureSensor**|*O3EComplexType*|9||Flow temperature in the primary circuit after the heat generator.|[Link](https://github.com/open3e/open3e/discussions/161)|
| |- Actual|O3EInt16|2|°C|||
| |- Minimum|O3EInt16|2|°C|||
| |- Maximum|O3EInt16|2|°C|||
| |- Average|O3EInt16|2|°C|||
